...
autocomplete_add cmd_family_clickhouse_services "clickhouse"
...
autocomplete_add cmd_family_rabbitmq_services "rabbitmq"
autocomplete_add cmd_family_redis "admin" "app"
autocomplete_add cmd_family_redis_batch "redis"
autocomplete_add cmd_family_redis_services "redis"
...
autocomplete_add cmd_family_stand "foo"
autocomplete_add_key "foo"
autocomplete_add foo "up down cargo_deps install_services prepare_services"