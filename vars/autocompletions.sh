...
autocomplete_add cmd_family_clickhouse_install \
  "clickhouse"
autocomplete_add cmd_family_rabbitmq_install \
  "rabbitmq"
autocomplete_add cmd_family_redis_install \
  "redis"
...
autocomplete_add cmd_family_cargo_workspace \
  "tetrix hui"
autocomplete_add cmd_family_cargo_package \
  "tetrix"
...
autocomplete_add cmd_family_redis_batch \
  "redis"
autocomplete_add cmd_family_redis \
  "admin" "app"

autocomplete_add cmd_family_rabbitmq_batch \
  "rabbitmq"
autocomplete_add cmd_family_rabbitmq \
  "app"

autocomplete_add cmd_family_python \
  "3.9.11"